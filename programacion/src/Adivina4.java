...
public class Adivina4 {
   ...
   */
   ...
   // Pide numeros hasta que el numero introducido este entre 1 y 100
   // Parametros:
   //    Scanner leerTeclado para leer datos por teclado
   ...
   public static int introNumValido(Scanner leerTeclado) {
      ...
      while (num < 1 || num > MAX_NUM) {
         System.out.print("Debe ser un numero entre 1 y " + MAX_NUM + ": ");
   ...
   // Pide datos hasta que se introduzca un numero entero
   // Mientras no sea un numero entero se lee con next y se descarta
   // Parametros:
   //    Scanner leerTeclado para leer datos por teclado
   // Return: un entero entre 1 y 100 
   public static int introNumEntero(Scanner leerTeclado) {
      ...
      while (!leerTeclado.hasNextInt()) {
         ...
         System.out.print("El dato debe ser un numero entero: ");         
      }
